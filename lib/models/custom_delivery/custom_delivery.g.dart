...
CustomDelivery _$CustomDeliveryFromJson(Map<String, dynamic> json) {
  return CustomDelivery(
    ...
    sourceLongitude: json['source_longitude'] as String,
    sourceLatitude: json['source_latitude'] as String,
    ...
    deliveryModeId: json['delivery_mode_id'] as int,
  );
}
...
Map<String, dynamic> _$CustomDeliveryToJson(CustomDelivery instance) =>
    <String, dynamic>{
      ...
      'meta': instance.meta,
      'delivery_mode_id': instance.deliveryModeId,
    };
